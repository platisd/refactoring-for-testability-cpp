#ifndef CPP_REFACTORING_WEBINAR_SINGLETASKASYNCHRONOUSTIMER_HPP
#define CPP_REFACTORING_WEBINAR_SINGLETASKASYNCHRONOUSTIMER_HPP
...
#endif // CPP_REFACTORING_WEBINAR_SINGLETASKASYNCHRONOUSTIMER_HPP
