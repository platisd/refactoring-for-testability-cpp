#ifndef CPP_REFACTORING_WEBINAR_DIRECTIONLESSODOMETER_HPP
#define CPP_REFACTORING_WEBINAR_DIRECTIONLESSODOMETER_HPP
...
#endif // CPP_REFACTORING_WEBINAR_DIRECTIONLESSODOMETER_HPP
