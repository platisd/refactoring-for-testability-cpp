#ifndef CPP_REFACTORING_WEBINAR_PULSESTOMETERSENCODER_HPP
#define CPP_REFACTORING_WEBINAR_PULSESTOMETERSENCODER_HPP
...
#endif // CPP_REFACTORING_WEBINAR_PULSESTOMETERSENCODER_HPP
